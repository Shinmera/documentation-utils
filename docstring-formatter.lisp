...
(define-stream-visitors
    ...
    (generator default-docstring-formatter)
    node label data before
  ((function-node :side-effects string)
   (format output "Side Effects:~% ~a" data))
  ((function-node :side-effects list)
   (format output "Side Effects:~%~{ * ~a~%~}" data))
  ((function-node :side-effects (eql nil))
   (format output "No side effects."))
  ((function-node :arguments list)
   ...
   (loop for d on data
         do (destructuring-bind (arg desc) (first d)
              ...
              (unless (endp (rest d))
                (format output "~%")))))
  ((function-node :returns string)
   (format output "Returns:~% ~a" data))
  ((function-node :returns list)
   (format output "Returns:~%~{ * ~a~^~%~}" data))
  ...
  ((function-node :exceptional-situations list)
   (format output "Exceptional Situations:~%~{ * ~a~^~%~}" data))
  ((function-node :exceptional-situations string)
   (format output "Exceptional Situations:~% ~a" data)))
